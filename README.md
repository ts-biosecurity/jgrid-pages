...
|---|---|---|---|
| Myanmar | Google News, WHO DON | **GNLM**（国営紙 Global New Light Of Myanmar の RSS）<br>**WHO Myanmar / SEARO ニュース**（who.int/myanmar 系を HTML スクレイプ）<br>**WHO SEARO Epidemiological Bulletin**（隔週 PDF 速報、最新3号は PDF からミャンマー個別記述をセクション/ページ単位で抽出し EN→JA 翻訳） | `myanmar_infectious_diseases.json`<br>`myanmar_gnlm.json`<br>`myanmar_who.json`<br>`who_searo_epi.json`<br>`who_don.json` |
